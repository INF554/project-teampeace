...
@Component({
  selector: 'app-bubble-chart4',
  templateUrl: './bubble-chart4.component.html',
  styleUrls: ['./bubble-chart4.component.css']
})
export class BubbleChart4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    d3.json('cdata2012.json').then(function (data: Array<BubblesType>) {
