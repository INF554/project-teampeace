...
@Component({
  selector: 'app-scatter-se',
  templateUrl: './scatter-se.component.html',
  styleUrls: ['./scatter-se.component.css']
})
export class ScatterSeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    Promise.all(promises).then(function (values) {
      ...
      var svg = d3.select("#scatterChart2Div").append("svg")
      ...
      svg.selectAll("circle")
        ...
        .on("mouseover",function(this:any,d:any){
          ...
          d3.select('#tooltip-scatter1')
              ...
              .html('<h4>' + 'Year: '+d.year+'<br>'+" Countries at Wars: "+d. countCouWars +  '<br>'+'Total trade amount: '+d.numCountry+'<br>');
